...
/* Smarty version 3.1.39, created on 2022-03-16 14:53:53
  from '/sites/git.bronyfurry.com/view/tpl/chat.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_6231cfd19ab752_84692469',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e4c5c7789b86c845dd19aa89580abc9f77228737' => 
    array (
      0 => '/sites/git.bronyfurry.com/view/tpl/chat.tpl',
      1 => 1646166058,
      2 => 'file',
    ),
  ),
...
function content_6231cfd19ab752_84692469 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="generic-content-wrapper">
	<div class="section-title-wrapper">
		<div class="float-end">
			<?php if ($_smarty_tpl->tpl_vars['is_owner']->value) {?>
			<form id="chat-destroy" method="post" action="chat">
				<input type="hidden" name="room_name" value="<?php echo $_smarty_tpl->tpl_vars['room_name']->value;?>
" />
				<input type="hidden" name="action" value="drop" />
				<button class="btn btn-danger btn-sm" type="submit" name="submit" value="<?php echo $_smarty_tpl->tpl_vars['drop']->value;?>
" onclick="return confirmDelete();"><i class="fa fa-trash-o"></i>&nbsp;<?php echo $_smarty_tpl->tpl_vars['drop']->value;?>
</button>
			</form>
			<?php }?>
		...
		<h2><?php echo $_smarty_tpl->tpl_vars['room_name']->value;?>
</h2>
		<div class="clear"></div>
	</div>
...
" />
				...
				<div id="chat-submit-wrapper" class="clearfix">
					<div id="chat-submit" class="dropup float-end">
						...
						<button class="btn btn-primary btn-sm" type="submit" id="chat-submit" name="submit" value="<?php echo $_smarty_tpl->tpl_vars['submit']->value;?>
"><?php echo $_smarty_tpl->tpl_vars['submit']->value;?>
</button>
						<div class="dropdown-menu dropdown-menu-end">
							<a class="dropdown-item" href="<?php echo $_smarty_tpl->tpl_vars['baseurl']->value;?>
/chatsvc?f=&room_id=<?php echo $_smarty_tpl->tpl_vars['room_id']->value;?>
&status=online"><i class="fa fa-circle online"></i>&nbsp;<?php echo $_smarty_tpl->tpl_vars['online']->value;?>
</a>
							<a class="dropdown-item" href="<?php echo $_smarty_tpl->tpl_vars['baseurl']->value;?>
/chatsvc?f=&room_id=<?php echo $_smarty_tpl->tpl_vars['room_id']->value;?>
&status=away"><i class="fa fa-circle away"></i>&nbsp;<?php echo $_smarty_tpl->tpl_vars['away']->value;?>
</a>
							<a class="dropdown-item" href="<?php echo $_smarty_tpl->tpl_vars['baseurl']->value;?>
/chat/<?php echo $_smarty_tpl->tpl_vars['nickname']->value;?>
/<?php echo $_smarty_tpl->tpl_vars['room_id']->value;?>
/leave"><i class="fa fa-circle leave"></i>&nbsp;<?php echo $_smarty_tpl->tpl_vars['leave']->value;?>
</a>
							...
							<?php if ($_smarty_tpl->tpl_vars['bookmark_link']->value) {?>
                         				<div class="dropdown-divider"></div>
							<a class="dropdown-item" href="<?php echo $_smarty_tpl->tpl_vars['bookmark_link']->value;?>
" target="_blank" ><i class="fa fa-bookmark"></i>&nbsp;<?php echo $_smarty_tpl->tpl_vars['bookmark']->value;?>
</a>
							<?php }?>
						</div>
					</div>
					<div id="chat-tools" class="btn-toolbar">
						<div class="btn-group me-2">
							<button id="main-editor-bold" class="btn btn-outline-secondary btn-sm" title="<?php echo $_smarty_tpl->tpl_vars['bold']->value;?>
" onclick="inserteditortag('b', 'chatText'); return false;">
								<i class="fa fa-bold jot-icons"></i>
							</button>
							<button id="main-editor-italic" class="btn btn-outline-secondary btn-sm" title="<?php echo $_smarty_tpl->tpl_vars['italic']->value;?>
" onclick="inserteditortag('i', 'chatText'); return false;">
								<i class="fa fa-italic jot-icons"></i>
							</button>
							<button id="main-editor-underline" class="btn btn-outline-secondary btn-sm" title="<?php echo $_smarty_tpl->tpl_vars['underline']->value;?>
" onclick="inserteditortag('u', 'chatText'); return false;">
								<i class="fa fa-underline jot-icons"></i>
							</button>
							<button id="main-editor-quote" class="btn btn-outline-secondary btn-sm" title="<?php echo $_smarty_tpl->tpl_vars['quote']->value;?>
" onclick="inserteditortag('quote', 'chatText'); return false;">
								<i class="fa fa-quote-left jot-icons"></i>
							</button>
							<button id="main-editor-code" class="btn btn-outline-secondary btn-sm" title="<?php echo $_smarty_tpl->tpl_vars['code']->value;?>
" onclick="inserteditortag('code', 'chatText'); return false;">
						...
						<div class="btn-group me-2 d-none d-md-flex">
							<button id="chat-link-wrapper" class="btn btn-outline-secondary btn-sm" onclick="chatJotGetLink(); return false;" >
								<i id="chat-link" class="fa fa-link jot-icons" title="<?php echo $_smarty_tpl->tpl_vars['insert']->value;?>
" ></i>
							</button>
						</div>
						<?php if ($_smarty_tpl->tpl_vars['feature_encrypt']->value) {?>
						<div class="btn-group me-2 d-none d-md-flex">
							<button id="chat-encrypt-wrapper" class="btn btn-outline-secondary btn-sm" onclick="hz_encrypt('<?php echo $_smarty_tpl->tpl_vars['cipher']->value;?>
', '#chatText'); return false;">
								<i id="chat-encrypt" class="fa fa-key jot-icons" title="<?php echo $_smarty_tpl->tpl_vars['encrypt']->value;?>
" ></i>
							</button>
						</div>
						<?php }?>
						<div class="btn-group dropup d-md-none">
							...
							<div class="dropdown-menu">
								<a class="dropdown-item" href="#" onclick="chatJotGetLink(); return false;" ><i class="fa fa-link"></i>&nbsp;<?php echo $_smarty_tpl->tpl_vars['insert']->value;?>
</a>
								<?php if ($_smarty_tpl->tpl_vars['feature_encrypt']->value) {?>
								<div class="dropdown-divider"></div>
								<a class="dropdown-item" href="#" onclick="hz_encrypt('<?php echo $_smarty_tpl->tpl_vars['cipher']->value;?>
', '#chatText'); return false;"><i class="fa fa-key"></i>&nbsp;<?php echo $_smarty_tpl->tpl_vars['encrypt']->value;?>
</a>
								<?php }?>
							</div>
						</div>
...
<?php echo '<script'; ?>
>
var room_id = <?php echo $_smarty_tpl->tpl_vars['room_id']->value;?>
;
var last_chat = 0;
var chat_timer = null;
