...
/* Smarty version 3.1.39, created on 2022-03-16 13:13:04
  from '/sites/git.bronyfurry.com/view/tpl/notifications_widget.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_6231b830a3aeb7_23765834',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a38362538a73d4b3f76989328ca7d9d7b4132ac5' => 
    array (
      0 => '/sites/git.bronyfurry.com/view/tpl/notifications_widget.tpl',
      1 => 1646166058,
      2 => 'file',
    ),
  ),
...
function content_6231b830a3aeb7_23765834 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
>
...
?>
	<?php if ($_smarty_tpl->tpl_vars['notification']->value['filter']) {?>
	$(document).on('click', '#tt-<?php echo $_smarty_tpl->tpl_vars['notification']->value['type'];?>
-only', function(e) {
		if($(this).hasClass('active sticky-top')) {
			$('#nav-<?php echo $_smarty_tpl->tpl_vars['notification']->value['type'];?>
-menu .notification[data-thread_top=false]').removeClass('tt-filter-active');
			$(this).removeClass('active sticky-top');
		}
		else {
			$('#nav-<?php echo $_smarty_tpl->tpl_vars['notification']->value['type'];?>
-menu .notification[data-thread_top=false]').addClass('tt-filter-active');
	...
	$(document).on('click', '#cn-<?php echo $_smarty_tpl->tpl_vars['notification']->value['type'];?>
-input-clear', function(e) {
		$('#cn-<?php echo $_smarty_tpl->tpl_vars['notification']->value['type'];?>
-input').val('');
		$('#cn-<?php echo $_smarty_tpl->tpl_vars['notification']->value['type'];?>
-only').removeClass('active sticky-top');
		$("#nav-<?php echo $_smarty_tpl->tpl_vars['notification']->value['type'];?>
-menu .notification").removeClass('cn-filter-active');
		$('#cn-<?php echo $_smarty_tpl->tpl_vars['notification']->value['type'];?>
-input-clear').addClass('d-none');
	});

	$(document).on('input', '#cn-<?php echo $_smarty_tpl->tpl_vars['notification']->value['type'];?>
-input', function(e) {
		var val = $('#cn-<?php echo $_smarty_tpl->tpl_vars['notification']->value['type'];?>
-input').val().toString().toLowerCase();
		if(val) {
			val = val.indexOf('%') == 0 ? val.substring(1) : val;
			$('#cn-<?php echo $_smarty_tpl->tpl_vars['notification']->value['type'];?>
-only').addClass('active sticky-top');
			$('#cn-<?php echo $_smarty_tpl->tpl_vars['notification']->value['type'];?>
-input-clear').removeClass('d-none');
		}
		else {
			$('#cn-<?php echo $_smarty_tpl->tpl_vars['notification']->value['type'];?>
-only').removeClass('active sticky-top');
...
-input-clear').addClass('d-none');
		...
		$("#nav-<?php echo $_smarty_tpl->tpl_vars['notification']->value['type'];?>
-menu .notification").each(function(i, el){
...
<div id="notifications_wrapper" class="mb-4">
	<div id="no_notifications" class="d-xl-none">
		<?php echo $_smarty_tpl->tpl_vars['no_notifications']->value;?>
...
$_smarty_tpl->tpl_vars['notification']->do_else = false;
?>
		<div class="border border-start-0 border-end-0 border-bottom-0 list-group list-group-flush collapse <?php echo $_smarty_tpl->tpl_vars['notification']->value['type'];?>
-button">
			<a id="notification-link-<?php echo $_smarty_tpl->tpl_vars['notification']->value['type'];?>
" class="collapsed list-group-item fakelink notification-link" href="#" title="<?php echo $_smarty_tpl->tpl_vars['notification']->value['title'];?>
" data-bs-target="#nav-<?php echo $_smarty_tpl->tpl_vars['notification']->value['type'];?>
-sub" data-bs-toggle="collapse" data-sse_type="<?php echo $_smarty_tpl->tpl_vars['notification']->value['type'];?>
">
				<i class="fa fa-fw fa-<?php echo $_smarty_tpl->tpl_vars['notification']->value['icon'];?>
"></i> <?php echo $_smarty_tpl->tpl_vars['notification']->value['label'];?>

				<span class="float-end badge bg-<?php echo $_smarty_tpl->tpl_vars['notification']->value['severity'];?>
 <?php echo $_smarty_tpl->tpl_vars['notification']->value['type'];?>
-update"></span>
			</a>
		</div>
		<div id="nav-<?php echo $_smarty_tpl->tpl_vars['notification']->value['type'];?>
-sub" class="border border-start-0 border-end-0 border-bottom-0 list-group list-group-flush collapse notification-content" data-bs-parent="#notifications" data-sse_type="<?php echo $_smarty_tpl->tpl_vars['notification']->value['type'];?>
">
			<?php if ($_smarty_tpl->tpl_vars['notification']->value['viewall']) {?>
			<a class="list-group-item text-decoration-none text-dark" id="nav-<?php echo $_smarty_tpl->tpl_vars['notification']->value['type'];?>
-see-all" href="<?php echo $_smarty_tpl->tpl_vars['notification']->value['viewall']['url'];?>
">
				<i class="fa fa-fw fa-external-link"></i> <?php echo $_smarty_tpl->tpl_vars['notification']->value['viewall']['label'];?>

			</a>
			<?php }?>
			<?php if ($_smarty_tpl->tpl_vars['notification']->value['markall']) {?>
			<div class="list-group-item cursor-pointer" id="nav-<?php echo $_smarty_tpl->tpl_vars['notification']->value['type'];?>
-mark-all" onclick="markRead('<?php echo $_smarty_tpl->tpl_vars['notification']->value['type'];?>
'); return false;">
				<i class="fa fa-fw fa-check"></i> <?php echo $_smarty_tpl->tpl_vars['notification']->value['markall']['label'];?>

			</div>
			<?php }?>
			<?php if ($_smarty_tpl->tpl_vars['notification']->value['filter']) {?>
			<?php if ($_smarty_tpl->tpl_vars['notification']->value['filter']['posts_label']) {?>
			<div class="list-group-item cursor-pointer" id="tt-<?php echo $_smarty_tpl->tpl_vars['notification']->value['type'];?>
-only">
				<i class="fa fa-fw fa-filter"></i> <?php echo $_smarty_tpl->tpl_vars['notification']->value['filter']['posts_label'];?>

			</div>
			<?php }?>
			<?php if ($_smarty_tpl->tpl_vars['notification']->value['filter']['name_label']) {?>
			<div class="list-group-item clearfix notifications-textinput" id="cn-<?php echo $_smarty_tpl->tpl_vars['notification']->value['type'];?>
-only">
				<div class="text-muted notifications-textinput-filter"><i class="fa fa-fw fa-filter"></i></div>
				<input id="cn-<?php echo $_smarty_tpl->tpl_vars['notification']->value['type'];?>
-input" type="text" class="notification-filter form-control form-control-sm" placeholder="<?php echo $_smarty_tpl->tpl_vars['notification']->value['filter']['name_label'];?>
">
				<div id="cn-<?php echo $_smarty_tpl->tpl_vars['notification']->value['type'];?>
-input-clear" class="text-muted notifications-textinput-clear d-none"><i class="fa fa-times"></i></div>
			</div>
			<?php }?>
			<?php }?>
			<div id="nav-<?php echo $_smarty_tpl->tpl_vars['notification']->value['type'];?>
-menu" class="list-group list-group-flush"></div>
			<div id="nav-<?php echo $_smarty_tpl->tpl_vars['notification']->value['type'];?>
-loading" class="list-group-item" style="display: none;">
				<?php echo $_smarty_tpl->tpl_vars['loading']->value;?>
<span class="jumping-dots"><span class="dot-1">.</span><span class="dot-2">.</span><span class="dot-3">.</span></span>
			</div>
		</div>
		<?php
