...
/* Smarty version 3.1.39, created on 2022-03-16 13:19:30
  from '/sites/git.bronyfurry.com/view/tpl/conv_item.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_6231b9b2683e45_97493886',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e12f22601e45d8856c075504cdf25f872bf3e079' => 
    array (
      0 => '/sites/git.bronyfurry.com/view/tpl/conv_item.tpl',
      1 => 1646166058,
      2 => 'file',
    ),
  ),
...
function content_6231b9b2683e45_97493886 (Smarty_Internal_Template $_smarty_tpl) {
if ($_smarty_tpl->tpl_vars['item']->value['comment_firstcollapsed']) {?>
<div id="hide-comments-outer-<?php echo $_smarty_tpl->tpl_vars['item']->value['parent'];?>
" class="hide-comments-outer fakelink" onclick="showHideComments(<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
);">
...
if ($_smarty_tpl->tpl_vars['item']->value['is_new'] && !$_smarty_tpl->tpl_vars['item']->value['event'] && !$_smarty_tpl->tpl_vars['item']->value['is_comment']) {?> wall-item-head-new<?php }?>" >
					<?php if ($_smarty_tpl->tpl_vars['item']->value['thr_parent']) {?>
						<a href="javascript:doscroll('<?php echo $_smarty_tpl->tpl_vars['item']->value['thr_parent'];?>
',<?php echo $_smarty_tpl->tpl_vars['item']->value['parent'];?>
);" title="<?php echo $_smarty_tpl->tpl_vars['item']->value['top_hint'];?>
" class="float-end"><i class="fa fa-angle-double-up">&nbsp;&nbsp;&nbsp;</i></a>
					<?php }?>
					<?php if ($_smarty_tpl->tpl_vars['item']->value['pinned']) {?>
					    <span class="float-end wall-item-pinned" title="<?php echo $_smarty_tpl->tpl_vars['item']->value['pinned'];?>
" id="wall-item-pinned-<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
...
" loading="lazy" data-bs-toggle="dropdown" />
...
}?></span>&nbsp;<?php if ($_smarty_tpl->tpl_vars['item']->value['delayed']) {?><i class="fa fa-clock-o"></i><?php }
if ($_smarty_tpl->tpl_vars['item']->value['editedtime']) {?>&nbsp;<i class="fa fa-pencil"></i><?php }?>&nbsp;<?php if ($_smarty_tpl->tpl_vars['item']->value['app']) {?><span class="item.app"><?php echo $_smarty_tpl->tpl_vars['item']->value['str_app'];?>
</span><?php }?>
					</div>
				</div>
...
,'dislike'); return false;">
							...
							<?php }?>
							<?php if ($_smarty_tpl->tpl_vars['item']->value['reply_to']) {?>
							<button type="button" title="<?php echo $_smarty_tpl->tpl_vars['item']->value['reply_to'][0];?>
" class="btn btn-outline-secondary btn-sm" onclick="doreply(<?php echo $_smarty_tpl->tpl_vars['item']->value['parent'];?>
, <?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
, '<?php echo $_smarty_tpl->tpl_vars['item']->value['author_id'];?>
', '<?php echo $_smarty_tpl->tpl_vars['item']->value['reply_to'][2];?>
 <?php echo strtr($_smarty_tpl->tpl_vars['item']->value['name'], array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/" ));?>
');">
...
">
								...
								<div class="dropdown-menu dropdown-menu-end" role="menu" aria-labelledby="wall-item-consensus-menu-<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
">
...
"></i><?php echo $_smarty_tpl->tpl_vars['item']->value['filer'];?>
									...
									<?php }?>
									<?php if ($_smarty_tpl->tpl_vars['item']->value['pinnable']) {?>
									<a class="dropdown-item dropdown-item-pinnable" href="#" onclick="dopin(<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
); return false;" id="item-pinnable-<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
"><i class="generic-icons-nav fa fa-fw fa-thumb-tack"></i><?php echo $_smarty_tpl->tpl_vars['item']->value['pinme'];?>
</a>
									<?php }?>
...
" ><i class="generic-icons-nav fa fa-fw fa-trash-o"></i><?php echo $_smarty_tpl->tpl_vars['item']->value['drop']['delete'];?>
									...
									<?php }?>
									<?php if ($_smarty_tpl->tpl_vars['item']->value['dropdown_extras']) {?>
									<div class="dropdown-divider"></div>
									<?php echo $_smarty_tpl->tpl_vars['item']->value['dropdown_extras'];?>

									<?php }?>
									<?php if ($_smarty_tpl->tpl_vars['item']->value['edpost'] && $_smarty_tpl->tpl_vars['item']->value['dreport']) {?>
									<div class="dropdown-divider"></div>
									<a class="dropdown-item" href="dreport/<?php echo $_smarty_tpl->tpl_vars['item']->value['dreport_link'];?>
"><?php echo $_smarty_tpl->tpl_vars['item']->value['dreport'];?>
</a>
									<?php }?>
									<?php if ($_smarty_tpl->tpl_vars['item']->value['settings']) {?>
									<div class="dropdown-divider"></div>
									<a class="dropdown-item conversation-settings-link" href="" data-bs-toggle="modal" data-bs-target="#conversation_settings"><?php echo $_smarty_tpl->tpl_vars['item']->value['settings'];?>
</a>
									<?php }?>
								</div>
							</div>
					...
					<?php if ($_smarty_tpl->tpl_vars['item']->value['responses'] || $_smarty_tpl->tpl_vars['item']->value['attachments']) {?>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<h3 class="modal-title"><?php echo $_smarty_tpl->tpl_vars['response']->value['count'];?>
 <?php echo $_smarty_tpl->tpl_vars['response']->value['button'];?>
</h3>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
		...
		<?php if ($_smarty_tpl->tpl_vars['item']->value['toplevel']) {?>
		<?php
...
?>
			<?php $_smarty_tpl->_subTemplateRender(((string)$_smarty_tpl->tpl_vars['child']->value['template']), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('item'=>$_smarty_tpl->tpl_vars['child']->value), 0, true);
?>
		<?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
		...
		<div id="wall-item-comment-wrapper-<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
" class="p-2 wall-item-comment-wrapper<?php if ($_smarty_tpl->tpl_vars['item']->value['children']) {?> wall-item-comment-wrapper-wc<?php }?>" >
